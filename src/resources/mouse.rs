...
pub fn mouse_input_system(mut mouse:ResMut<Mouse>, camera:Query<(&Camera, &Transform)>, mut mouse_moved_events:EventReader<CursorMoved>, windows:Res<Windows>) {
...
fn update_position_world(camera: &Query<(&Camera, &Transform)>, windows: &Res<Windows>, mouse: &mut ResMut<Mouse>) {
