...
use crate::{Body, components::{Velocity}};

pub fn physics_system(query:Query<(&mut Velocity, &mut Transform, &Body)>, time:Res<Time>) {
    query.for_each_mut(|(thrust, mut transform, mut body)| {
